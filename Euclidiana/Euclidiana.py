...
if (
    ...
    with open("Euclidiana/datos_fitness.csv", mode="w", newline="") as file:
...
class Vehicle:
    ...
    def calculate_fitness(self):
        distance_to_goal = self.calculate_ecuclidian(self.map.lista_objetivo[0])
        fitness = max(0, 10000 - distance_to_goal)
        return fitness

    def calculate_ecuclidian(self, target_position):
        car_pos = self.center
        distance = math.sqrt(
            (car_pos[0] - target_position[0]) ** 2
            + (car_pos[1] - target_position[1]) ** 2
        )
...
class Game:
    ...
    def plot_statistics(self, stats):
        ...
        with open("Euclidiana/datos_fitness.csv", mode="a", newline="") as file:
            writer = csv.writer(file)

            if os.path.getsize("Euclidiana/datos_fitness.csv") == 0:
                writer.writerow(
                    ["Simulacion", "Generacion", "Mejor Fitness", "Fitness Promedio"]
                )
    ...
    def obtener_numero_simulacion(self):
        try:
            with open("Euclidiana/contador_simulaciones.txt", "r") as f:
        ...
        with open("Euclidiana/contador_simulaciones.txt", "w") as f:
    ...
    def eval_genomes(self, genomes, config):
        ...
        with open("Euclidiana/fitness_individual.csv", mode="a", newline="") as file:
