...
%Buscar indice de accidentes de transito en vehiculos

%Borrador - Ideas
%Vehiculos y transporte

%Accidentes
Uno de los mayores problemas del transporte moderno es el alto indice de accidentes en el tránsito terrestre, la gran cantidad de trafico atribuida a factores como errores humanos, falla mecánicas y fenómenos naturales. %Porcentaje
...
\begin{table*}[ht]
    \centering
    % Primer minipage para los Cuadros IV y V
    ...
    \end{minipage}
    \hfill
    % Segundo minipage para el Cuadro VI
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{Euclidiana/Fitnes_individual/Fitness_4_Eucli_50Gen.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{Euclidiana/Fitnes_individual/Fitness_4_Eucli_50Gen_Sombra.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{Euclidiana/Fitness_individual_30/Fitness_3_Eucli_30Gen_Sombra.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{Manhattan/Fitness_Individual_50Gen/Fitness_4_Manh_50Gen_Sombra.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.99\linewidth]{Chebyshev/Fitness_Individual_50Gen/Fitness_1_Cheby_50Gen.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.99\linewidth]{Chebyshev/Fitness_Individual_50Gen/Fitness_5_Cheby_50Gen.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.99\linewidth]{Chebyshev/Fitness_Individual_50Gen/Fitness_5_Cheby_50Gen_Sombra.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{Sin_Refuerzo_50Gen/Cheby_NoRef_50Gen.png}
...
%%Finalmente, la resolución de los sensores tuvo un impacto directo en la suavidad de los movimientos del agente, aunque una mayor resolución también permitió que este pudiera girar sobre su propio eje, lo cual podría influir en su desempeño en determinadas situaciones.
\printbibliography
\end{document}