...
\author{Over Alexander Mejia Rosado \textsuperscript{\href{https://orcid.org/0009-0008-8152-2754}{\faOrcid}}, 

Ronald Mateo Ceballos Lozano \textsuperscript{\href{mailto:rceballosl@unal.edu.co}{\faIcon{envelope}}}, 

Rhonald José Torres Diaz \textsuperscript{\href{mailto:rhtorresd@unal.edu.co}{\faIcon{envelope}}}, y\\

Juan Pablo Hoyos Sanchez \textsuperscript{\href{mailto:jhoyoss@unal.edu.co}{\faIcon{envelope}}}
}
...
La gráfica general de las desviaciones y promedios obtenidos para 20 genraciónes establecidas puede observarla en la sección \textit{(C) 20 Genraciones} en la Tabla \ref{tab:graficas_generales_Euclidiada}.
...
Con un fitness maximo de 9632, el primer entrenamiento obtuvo el segundo mejor puntaje, con una desviación por encima de los 8800 (Fig. \ref{fig:eucli_1_20}, \ref{fig:eucli_1_20_sombra}). Por otra parte, el quinto y tercer entrenamiento obtuvieron los fitness mas bajos con 8782 y 8773, con una desviación que no supera los 8750 (Fig. \ref{fig:eucli_5_20}, \ref{fig:eucli_5_20_sombra}, \ref{fig:eucli_3_20} y \ref{fig:eucli_3_20_sombra}).

\begin{table*}[ht]
    \centering
    \caption{Gráficas por genraciones para la distancia Euclidiana}
    \label{tab:graficas_generales_Euclidiada}
    \begin{tabular}{ccc}
    \includegraphics[width=0.3\textwidth]{Euclidiana/Fitness_Acumulado_Eucli_50Gen.png} &

    \includegraphics[width=0.3\textwidth]{Euclidiana/Fitness_Acumulado_Eucli_30Gen.png} &

    \includegraphics[width=0.3\textwidth, height=3.6cm]{Euclidiana/Fitness_Acumulado_Eucli_20Gen.png} \\
