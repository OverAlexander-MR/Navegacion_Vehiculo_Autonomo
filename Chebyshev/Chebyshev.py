...
if (
    ...
    with open("Chebyshev/datos_fitness.csv", mode="w", newline="") as file:
...
class Game:
    def __init__(self):
        pygame.init()
        self.map = Map("Maps/gta2.png", (255, 0, 0), (0, 255, 0), (0, 0, 255))
    ...
    def plot_statistics(self, stats):
        ...
        with open("Chebyshev/datos_fitness.csv", mode="a", newline="") as file:
            writer = csv.writer(file)

            if os.path.getsize("Chebyshev/datos_fitness.csv") == 0:
                writer.writerow(
                    ["Simulacion", "Generacion", "Mejor Fitness", "Fitness Promedio"]
                )
    ...
    def obtener_numero_simulacion(self):
        try:
            with open("Chebyshev/contador_simulaciones.txt", "r") as f:
        ...
        with open("Chebyshev/contador_simulaciones.txt", "w") as f:
    ...
    def eval_genomes(self, genomes, config):
        ...
        with open("Chebyshev/fitness_individual.csv", mode="a", newline="") as file:
